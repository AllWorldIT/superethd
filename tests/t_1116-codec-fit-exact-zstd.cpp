...
TEST_CASE("Check encoding of a packet that will fit exactly into MSS with ZSTD compression", "[codec]") {
	...
	accl::BufferPool<PacketBuffer> avail_buffer_pool(buffer_size, 9);
